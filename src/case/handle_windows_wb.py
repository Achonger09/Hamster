...
class HandleWindows(object):
    ...
    def _show_case_list(
        self, text="Case List", f_width=220, f_height=520, b_width=30, b_height=35
    ):
    ...
    def _show_case_title(
        self, text="Title", f_width=380, f_height=50, b_width=39, b_height=1
    ):
        py_frame2 = tk.LabelFrame(
            self.root_windows, text="Title", width=f_width, height=f_height
        )
        py_frame2.place(x=260, y=5)
        if self.handle_case:
    ...
    def _show_case_steps(
        self, text="Steps", f_width=380, f_height=250, b_width=51, b_height=27
    ):
        py_frame2 = tk.LabelFrame(
            self.root_windows, text="Steps", width=f_width, height=f_height
        )
        py_frame2.place(x=260, y=55)
        if self.handle_case:
    ...
    def _show_record_button(self):
        ...
        update_button1.place(x=1350, y=690)
    ...
    def _show_import_button(self):
        ...
        update_button2.place(x=900, y=690)
    ...
    def _show_export_button(self):
        ...
        update_button3.place(x=360, y=690)
    ...
    def _show_reflush_button(self):
        ...
        update_button3.place(x=70, y=690)
